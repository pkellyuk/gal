...
class ThrowableSphere(Entity):
    """A sphere that can be thrown and affected by physics."""
    ...
    #==============================
    def update(self):
        """Update sphere physics each frame."""
        dt = time.dt
...
def create_throwable_sphere(spawn_position, throw_direction):
    """Create and return a new throwable sphere instance."""
    return ThrowableSphere(spawn_position, throw_direction)
