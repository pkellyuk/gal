...
class ThrowableCube(Entity):
    """A cube that can be thrown and affected by physics."""
    ...
    #==============================
    def update(self):
        """Update cube physics each frame."""
        dt = time.dt
...
def create_throwable_cube(spawn_position, throw_direction):
    """Create and return a new throwable cube instance."""
    return ThrowableCube(spawn_position, throw_direction)
